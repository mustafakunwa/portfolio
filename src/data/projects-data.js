...
export const projectsData = [
    {
        ...
        projectDesc: 'This project about checkout page. Customer can be buy product and manage them and make payment.',
        tags: ['React', 'SCSS', 'Redux'],
        code: '',
        demo: 'https://devguide.payu.in/',
        image: checkout
    },
    {
        id: 2,
    ...
    {
        id: 3,
        projectName: 'Runner Spot',
        projectDesc: 'This project is about racing event, where user can register for event and manage them.',
        tags: ['Angular', 'SCSS', 'Material Ui'],
        demo: 'https://runnerspot.com/',
        image: runnerspot
    },
    {
        id: 4,
        projectName: 'Curofone',
        projectDesc: 'Curofone ® Patient monitoring system made for your care ! ',
        tags: ['Angular', 'SCSS', 'Material Ui'],
        code: '',
